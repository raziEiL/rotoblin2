...
public Action:_RS_ReportStatus_Command(client, const String:command[], argc)
{
	...
	new iArraySize = GetArraySize(g_aConVarArray);
	...
	Format(result, sizeof(result), "%slisting %i cvars:", result, (iArraySize / CVAR_ARRAY_BLOCK));
	...
	for (new i = FIRST_CVAR_IN_ARRAY; i < iArraySize; i += CVAR_ARRAY_BLOCK)
	{
